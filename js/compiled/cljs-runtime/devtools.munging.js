...
var o41124 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41124["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41127 = temp__5733__auto____$1;
return (o41127["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40947__auto__ = f;
return (o__40947__auto__["toString"]).call(o__40947__auto__);
} else {
return "";
}
}catch (e41137){var _ = e41137;
return "";
}});
...
try{var o__40947__auto___41848 = t;
(o__40947__auto___41848["cljs$lang$ctorPrWriter"]).call(o__40947__auto___41848,t,writer);
}catch (e41158){var __41850 = e41158;
}
...
var char_code = (function (){var o__40947__auto__ = (new String(char$));
return (o__40947__auto__["charCodeAt"]).call(o__40947__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40947__auto__ = String;
return (o__40947__auto__["fromCharCode"]).call(o__40947__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41194 = num_code;
switch (G__41194) {
case (1):
return (185);
...
var o__40947__auto__ = String;
return (o__40947__auto__["fromCharCode"]).call(o__40947__auto__,superscript_code);
});
/**
...
}catch (e41231){var _e__40962__auto__ = e41231;
return false;
}})())){
...
var vec__41234 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41234,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41301){
var vec__41302 = p__41301;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41302,(0),null);
...
var G__41880 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41881 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41880;
remaining_tokens = G__41881;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41288){
var G__41289 = cljs.core.first(seq41288);
var seq41288__$1 = cljs.core.next(seq41288);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41289,seq41288__$1);
}));
...
var vec__41343 = cljs.core.split_with((function (p1__41336_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41336_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41343,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41343,(1),null);
...
var vec__41365 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41365,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41365,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41886 = cljs.core.rest(remaining_tokens);
var G__41887 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41886;
name_tokens = G__41887;
continue;
} else {
...
var vec__41389 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41389,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41389,(1),null);
var vec__41393 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41393,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41393,(1),null);
var vec__41396 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41396,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41396,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41396,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41396,(3),null);
...
var vec__41427 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41427,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41437 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41437,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41437,(1),null);
var vec__41441 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41441,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41441,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41454 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41454) : devtools.munging.parse_fn_info_deep.call(null,G__41454));
})()));
}
} else {
return fn_info;
...
var G__41919 = (arity + (1));
var G__41920 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41517){
var vec__41520 = p__41517;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41520,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41520,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41562_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41562_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41563_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41563_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41578){
var vec__41579 = p__41578;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41579,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41572){
var G__41573 = cljs.core.first(seq41572);
var seq41572__$1 = cljs.core.next(seq41572);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41573,seq41572__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41645__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41645__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41645__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41645__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41646 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41646,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41646,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41646,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41646,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41646,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41646,(5),null);
...
var o__40947__auto__ = f;
return (o__40947__auto__["getBasis"]).call(o__40947__auto__);
});
/**
...
}catch (e41669){var _e__40962__auto__ = e41669;
...
var G__41942 = (obj[cljs.core.first(path)]);
var G__41943 = cljs.core.rest(path);
obj = G__41942;
path = G__41943;
continue;
} else {
...
var _STAR_ = (function (accum,p__41733){
var vec__41734 = p__41733;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41734,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41734,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41758){
var vec__41761 = p__41758;
...
var post_process = (function (p__41796){
var vec__41801 = p__41796;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41801,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41801,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41779_SHARP_){
return (obj[cljs.core.first(p1__41779_SHARP_)]);
}),sorted_matches);
