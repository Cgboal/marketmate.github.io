...
}catch (e42031){var _e = e42031;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___42092 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___42092)){
var seen_errors_42094 = temp__5733__auto___42092;
if(cljs.core.truth_(seen_errors_42094.has(self))){
} else {
seen_errors_42094.add(self);

var temp__5735__auto___42102 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___42102)){
var sense_42103 = temp__5735__auto___42102;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42103)].join(''));
} else {
}
}
} else {
