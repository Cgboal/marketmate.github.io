...
return [(function (){var pred__43764 = cljs.core.instance_QMARK_;
var expr__43765 = reactive_val;
if(cljs.core.truth_((pred__43764.cljs$core$IFn$_invoke$arity$2 ? pred__43764.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__43765) : pred__43764.call(null,reagent.ratom.RAtom,expr__43765)))){
return "ra";
} else {
if(cljs.core.truth_((pred__43764.cljs$core$IFn$_invoke$arity$2 ? pred__43764.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__43765) : pred__43764.call(null,reagent.ratom.RCursor,expr__43765)))){
return "rc";
} else {
if(cljs.core.truth_((pred__43764.cljs$core$IFn$_invoke$arity$2 ? pred__43764.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__43765) : pred__43764.call(null,reagent.ratom.Reaction,expr__43765)))){
return "rx";
} else {
if(cljs.core.truth_((pred__43764.cljs$core$IFn$_invoke$arity$2 ? pred__43764.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__43765) : pred__43764.call(null,reagent.ratom.Track,expr__43765)))){
return "tr";
} else {
return "other";
}
