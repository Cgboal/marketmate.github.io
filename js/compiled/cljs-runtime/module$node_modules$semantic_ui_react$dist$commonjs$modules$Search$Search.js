...
function(rest){var _this$props2=_this.props,icon=_this$props2.icon,value=_this.state.value;return _Input.default.create(_this$props2.input,{autoGenerateKey:!1,defaultProps:(0,_extends2.default)({},rest,{autoComplete:"off",icon:icon,onChange:_this.handleSearchChange,onClick:_this.handleInputClick,tabIndex:"0",value:value}),overrideProps:overrideSearchInputProps})};_this.renderNoResults=function(){var _this$props3=_this.props,noResultsDescription=_this$props3.noResultsDescription;return _react.default.createElement("div",
{className:"message empty"},_react.default.createElement("div",{className:"header"},_this$props3.noResultsMessage),noResultsDescription&&_react.default.createElement("div",{className:"description"},noResultsDescription))};_this.renderResult=function(_ref2,index,_array,offset){_array=_ref2.childKey;_ref2=(0,_objectWithoutPropertiesLoose2.default)(_ref2,["childKey"]);void 0===offset&&(offset=0);var resultRenderer=_this.props.resultRenderer,selectedIndex=_this.state.selectedIndex;index+=offset;return _react.default.createElement(_SearchResult.default,
(0,_extends2.default)({key:null!=_array?_array:_ref2.id||_ref2.title,active:selectedIndex===index,onClick:_this.handleItemClick,onMouseDown:_this.handleItemMouseDown,renderer:resultRenderer},_ref2,{id:index}))};_this.renderResults=function(){var results=_this.props.results;return(0,_map2.default)(results,_this.renderResult)};_this.renderCategories=function(){var _this$props4=_this.props,categoryLayoutRenderer=_this$props4.categoryLayoutRenderer,categoryRenderer=_this$props4.categoryRenderer;_this$props4=
_this$props4.results;var selectedIndex=_this.state.selectedIndex,count=0;return(0,_map2.default)(_this$props4,function(_ref3){var childKey=_ref3.childKey;_ref3=(0,_objectWithoutPropertiesLoose2.default)(_ref3,["childKey"]);childKey=(0,_extends2.default)({key:null!=childKey?childKey:_ref3.name,active:(0,_inRange2.default)(selectedIndex,count,count+_ref3.results.length),layoutRenderer:categoryLayoutRenderer,renderer:categoryRenderer},_ref3);var renderFn=(0,_partialRight2.default)(_this.renderResult,
count);count+=_ref3.results.length;return _react.default.createElement(_SearchCategory.default,childKey,_ref3.results.map(renderFn))})};_this.renderMenuContent=function(){var _this$props5=_this.props,category=_this$props5.category,showNoResults=_this$props5.showNoResults;_this$props5=_this$props5.results;return(0,_isEmpty2.default)(_this$props5)?showNoResults?_this.renderNoResults():null:category?_this.renderCategories():_this.renderResults()};_this.renderResultsMenu=function(){var resultsClasses=
_this.state.open?"visible":"",menuContent=_this.renderMenuContent();if(menuContent)return _react.default.createElement(_SearchResults.default,{className:resultsClasses},menuContent)};return _this}(0,_inheritsLoose2.default)(Search,_Component);Search.getAutoControlledStateFromProps=function(props,state){return"undefined"!==typeof state.prevValue&&(0,_shallowequal.default)(state.prevValue,state.value)?{prevValue:state.value}:{prevValue:state.value,selectedIndex:props.selectFirstResult?0:-1}};var _proto=
Search.prototype;_proto.shouldComponentUpdate=function(nextProps,nextState){return!(0,_shallowequal.default)(nextProps,this.props)||!(0,_shallowequal.default)(nextState,this.state)};_proto.componentDidUpdate=function(prevProps,prevState){!prevState.focus&&this.state.focus?(this.isMouseDown||this.tryOpen(),this.state.open&&_lib.eventStack.sub("keydown",[this.moveSelectionOnKeyDown,this.selectItemOnEnter])):prevState.focus&&!this.state.focus&&(this.isMouseDown||this.close(),_lib.eventStack.unsub("keydown",
[this.moveSelectionOnKeyDown,this.selectItemOnEnter]));!prevState.open&&this.state.open?(this.open(),_lib.eventStack.sub("click",this.closeOnDocumentClick),_lib.eventStack.sub("keydown",[this.closeOnEscape,this.moveSelectionOnKeyDown,this.selectItemOnEnter])):prevState.open&&!this.state.open&&(this.close(),_lib.eventStack.unsub("click",this.closeOnDocumentClick),_lib.eventStack.unsub("keydown",[this.closeOnEscape,this.moveSelectionOnKeyDown,this.selectItemOnEnter]))};_proto.componentWillUnmount=function(){_lib.eventStack.unsub("click",
this.closeOnDocumentClick);_lib.eventStack.unsub("keydown",[this.closeOnEscape,this.moveSelectionOnKeyDown,this.selectItemOnEnter])};_proto.render=function(){var _this$state=this.state,searchClasses=_this$state.searchClasses,focus=_this$state.focus;_this$state=_this$state.open;var _this$props6=this.props,aligned=_this$props6.aligned,category=_this$props6.category,className=_this$props6.className,fluid=_this$props6.fluid,loading=_this$props6.loading;_this$props6=_this$props6.size;searchClasses=(0,
_clsx.default)("ui",_this$state&&"active visible",_this$props6,searchClasses,(0,_lib.useKeyOnly)(category,"category"),(0,_lib.useKeyOnly)(focus,"focus"),(0,_lib.useKeyOnly)(fluid,"fluid"),(0,_lib.useKeyOnly)(loading,"loading"),(0,_lib.useValueAndKey)(aligned,"aligned"),"search",className);_this$state=(0,_lib.getUnhandledProps)(Search,this.props);focus=(0,_lib.getElementType)(Search,this.props);aligned=(0,_lib.partitionHTMLProps)(_this$state,{htmlProps:_lib.htmlInputAttrs});_this$state=aligned[0];
aligned=aligned[1];return _react.default.createElement(focus,(0,_extends2.default)({},aligned,{className:searchClasses,onBlur:this.handleBlur,onFocus:this.handleFocus,onMouseDown:this.handleMouseDown}),this.renderSearchInput(_this$state),this.renderResultsMenu())};return Search}(_lib.ModernAutoControlledComponent);exports.default=require;require.handledProps="aligned as category categoryLayoutRenderer categoryRenderer className defaultOpen defaultValue fluid icon input loading minCharacters noResultsDescription noResultsMessage onBlur onFocus onMouseDown onResultSelect onSearchChange onSelectionChange open resultRenderer results selectFirstResult showNoResults size value".split(" ");
require.propTypes={as:module.default.elementType,defaultOpen:module.default.bool,defaultValue:module.default.string,icon:module.default.oneOfType([module.default.node,module.default.object]),minCharacters:module.default.number,noResultsDescription:module.default.node,noResultsMessage:module.default.node,open:module.default.bool,results:module.default.oneOfType([module.default.arrayOf(module.default.shape(_SearchResult.default.propTypes)),module.default.shape(_SearchCategory.default.propTypes)]),selectFirstResult:module.default.bool,
showNoResults:module.default.bool,value:module.default.string,categoryLayoutRenderer:module.default.func,categoryRenderer:module.default.func,resultRenderer:module.default.func,onBlur:module.default.func,onFocus:module.default.func,onMouseDown:module.default.func,onResultSelect:module.default.func,onSearchChange:module.default.func,onSelectionChange:module.default.func,aligned:module.default.string,category:module.default.bool,className:module.default.string,fluid:module.default.bool,input:_lib.customPropTypes.itemShorthand,
loading:module.default.bool,size:module.default.oneOf((0,global.default)(_lib.SUI.SIZES,"medium"))};require.defaultProps={icon:"search",input:"text",minCharacters:1,noResultsMessage:"No results found.",showNoResults:!0};require.autoControlledProps=["open","value"];require.Category=_SearchCategory.default;require.Result=_SearchResult.default;require.Results=_SearchResults.default}
