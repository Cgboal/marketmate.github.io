...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_49954 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_49954(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_49959 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_49959(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49971 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_49971(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49985 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_49985(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_50011 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_50011(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_50017 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_50017(reader);
}
});
...
var G__50130 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__50131 = s.append(c);
c = G__50130;
s = G__50131;
continue;
}
