...
if((i < len)){
var k = (ks[i]);
var G__43091 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__43092 = (i + (1));
m = G__43091;
i = G__43092;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__42887 = c;
var G__42887__$1 = (((G__42887 == null))?null:G__42887.prototype);
if((G__42887__$1 == null)){
return null;
} else {
return G__42887__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__42891 = c;
var G__42891__$1 = (((G__42891 == null))?null:G__42891.prototype);
if((G__42891__$1 == null)){
return null;
} else {
return G__42891__$1.render;
}
})() == null)))));
});
...
var G__42908 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__42908) : reagent.impl.component.as_element.call(null,G__42908));
};
var G__43116 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__43119__i = 0, G__43119__a = new Array(arguments.length -  0);
while (G__43119__i < G__43119__a.length) {G__43119__a[G__43119__i] = arguments[G__43119__i + 0]; ++G__43119__i;}
  args = new cljs.core.IndexedSeq(G__43119__a,0,null);
} 
return G__43116__delegate.call(this,args);};
G__43116.cljs$lang$maxFixedArity = 0;
G__43116.cljs$lang$applyTo = (function (arglist__43120){
var args = cljs.core.seq(arglist__43120);
...
var G__42921 = c;
var G__42921__$1 = (((G__42921 == null))?null:G__42921.constructor);
if((G__42921__$1 == null)){
return null;
} else {
return G__42921__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__42922 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__42924 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__42924);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__42922);
}});
...
var c = this;
var G__42979_43141 = goog.object.get(c,"cljsRatom");
if((G__42979_43141 == null)){
} else {
reagent.ratom.dispose_BANG_(G__42979_43141);
}
...
var renders_43148 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_43149 = cljs.core.first(cljs.core.vals(renders_43148));
...
if((cljs.core.count(renders_43148) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_43148))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_43149)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_43149], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__43035 = o;
goog.object.set(G__43035,cljs.core.name(k),v);
