...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__50482_SHARP_,p2__50481_SHARP_){
if((p2__50481_SHARP_ == null)){
return null;
} else {
return p1__50482_SHARP_;
}
}),coll);
}
});
re_frisk.diff.diff.diff_coll = (function re_frisk$diff$diff$diff_coll(a,b){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function re_frisk$diff$diff$diff_coll_$_iter__50511(s__50512){
return (new cljs.core.LazySeq(null,(function (){
var s__50512__$1 = s__50512;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__50512__$1);
if(temp__5735__auto__){
var s__50512__$2 = temp__5735__auto__;
...
var key = cljs.core._nth(c__4527__auto__,i__50513);
cljs.core.chunk_append(b__50514,(function (){var val_a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(a,key);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50514),re_frisk$diff$diff$diff_coll_$_iter__50511(cljs.core.chunk_rest(s__50512__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50514),null);
}
} else {
var key = cljs.core.first(s__50512__$2);
...
})(),re_frisk$diff$diff$diff_coll_$_iter__50511(cljs.core.rest(s__50512__$2)));
}
} else {
return null;
}
