...
var i_49364 = (0);
while(true){
if((i_49364 < arr.length)){
(arr[i_49364] = null);

var G__49365 = (i_49364 + (1));
i_49364 = G__49365;
continue;
} else {
}
...
var i_49385 = (self__.level + (1));
while(true){
if((i_49385 <= (new_level + (1)))){
(update[i_49385] = self__.header);

var G__49387 = (i_49385 + (1));
i_49385 = G__49387;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_49391 = (update[i]).forward;
(x__$2.forward[i] = (links_49391[i]));
...
var i_49396 = (0);
while(true){
if((i_49396 <= self__.level)){
var links_49397 = (update[i_49396]).forward;
if((x__$1 === (((i_49396 < links_49397.length))?(links_49397[i_49396]):null))){
(links_49397[i_49396] = (x__$1.forward[i_49396]));

var G__49400 = (i_49396 + (1));
i_49396 = G__49400;
continue;
} else {
var G__49401 = (i_49396 + (1));
i_49396 = G__49401;
continue;
}
} else {
