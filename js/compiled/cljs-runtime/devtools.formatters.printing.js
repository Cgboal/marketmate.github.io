...
var G__42123 = (i__4737__auto___42121 + (1));
i__4737__auto___42121 = G__42123;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42024){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42025,G__42026,seq42024__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42043_SHARP_){
return (!((cljs.core.meta(p1__42043_SHARP_) == null)));
})))){
...
}catch (e42068){var _e__40962__auto__ = e42068;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42074){var _e__40962__auto__ = e42074;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42078 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42079 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42079);

try{var map__42080 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42080__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42078);
}});
...
var temp__5733__auto___42180 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42180)){
var managed_print_level_42183 = temp__5733__auto___42180;
var _STAR_print_level_STAR__orig_val__42095_42187 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42096_42188 = managed_print_level_42183;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42096_42188);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42089_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42089_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42095_42187);
}} else {
job_fn();
}
