...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49865_SHARP_,p2__49866_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__49865_SHARP_,p2__49866_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function re_com$tour$initialise_tour_$_iter__49882(s__49883){
return (new cljs.core.LazySeq(null,(function (){
var s__49883__$1 = s__49883;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__49883__$1);
if(temp__5735__auto__){
var s__49883__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49883__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__49883__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__49886 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__49885 = (0);
while(true){
if((i__49885 < size__4528__auto__)){
var step = cljs.core._nth(c__4527__auto__,i__49885);
cljs.core.chunk_append(b__49886,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__49966 = (i__49885 + (1));
i__49885 = G__49966;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49886),re_com$tour$initialise_tour_$_iter__49882(cljs.core.chunk_rest(s__49883__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49886),null);
}
} else {
var step = cljs.core.first(s__49883__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__49882(cljs.core.rest(s__49883__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__49902 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__49902.cljs$core$IFn$_invoke$arity$1 ? fexpr__49902.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__49902.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__49911 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__49911.cljs$core$IFn$_invoke$arity$1 ? fexpr__49911.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__49911.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__49917 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__49917.cljs$core$IFn$_invoke$arity$1 ? fexpr__49917.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__49917.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__49927 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__49927.cljs$core$IFn$_invoke$arity$1 ? fexpr__49927.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__49927.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__49933 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__49933.cljs$core$IFn$_invoke$arity$1 ? fexpr__49933.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__49933.call(null,tour));
})(),true);
} else {
return null;
}
