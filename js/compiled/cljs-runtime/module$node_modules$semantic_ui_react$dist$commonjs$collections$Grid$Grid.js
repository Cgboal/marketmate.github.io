shadow$provide.module$node_modules$semantic_ui_react$dist$commonjs$collections$Grid$Grid=function(global,require,module,exports){function Grid(props){var celled=props.celled,centered=props.centered,children=props.children,className=props.className,columns=props.columns,container=props.container,divided=props.divided,doubling=props.doubling,inverted=props.inverted,padded=props.padded,relaxed=props.relaxed,reversed=props.reversed,stackable=props.stackable,stretched=props.stretched,textAlign=props.textAlign,
verticalAlign=props.verticalAlign;celled=(0,_clsx.default)("ui",(0,_lib.useKeyOnly)(centered,"centered"),(0,_lib.useKeyOnly)(container,"container"),(0,_lib.useKeyOnly)(doubling,"doubling"),(0,_lib.useKeyOnly)(inverted,"inverted"),(0,_lib.useKeyOnly)(stackable,"stackable"),(0,_lib.useKeyOnly)(stretched,"stretched"),(0,_lib.useKeyOrValueAndKey)(celled,"celled"),(0,_lib.useKeyOrValueAndKey)(divided,"divided"),(0,_lib.useKeyOrValueAndKey)(padded,"padded"),(0,_lib.useKeyOrValueAndKey)(relaxed,"relaxed"),
(0,_lib.useMultipleProp)(reversed,"reversed"),(0,_lib.useTextAlignProp)(textAlign),(0,_lib.useVerticalAlignProp)(verticalAlign),(0,_lib.useWidthProp)(columns,"column",!0),"grid",className);centered=(0,_lib.getUnhandledProps)(Grid,props);props=(0,_lib.getElementType)(Grid,props);return _react.default.createElement(props,(0,_extends2.default)({},centered,{className:celled}),children)}var _interopRequireDefault=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");exports.__esModule=
