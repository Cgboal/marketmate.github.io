...
var periods__$1 = cljs.core.vec((function (){var G__47079 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47074_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__47074_SHARP_,(0),(3));
}),G__47079);
} else {
return G__47079;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__47161){
var vec__47162 = p__47161;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47162,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47162,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__47167 = pattern;
switch (G__47167) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47167)].join('')));
...
switch (G__47190__$1) {
case "millis":
return (function (p1__47179_SHARP_){
return p1__47179_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__47180_SHARP_){
return p1__47180_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__47181_SHARP_){
return p1__47181_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__47182_SHARP_){
return p1__47182_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__47184_SHARP_){
return p1__47184_SHARP_.getHours();
});

break;
case "day":
return (function (p1__47185_SHARP_){
return p1__47185_SHARP_.getDate();
});

break;
case "month":
return (function (p1__47187_SHARP_){
return p1__47187_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__47188_SHARP_){
return p1__47188_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47190__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__47204){
var vec__47206 = p__47204;
var seq__47207 = cljs.core.seq(vec__47206);
var first__47208 = cljs.core.first(seq__47207);
var seq__47207__$1 = cljs.core.next(seq__47207);
var key = first__47208;
var args = seq__47207__$1;
var G__47211 = key;
var G__47211__$1 = (((G__47211 instanceof cljs.core.Keyword))?G__47211.fqn:null);
switch (G__47211__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__47218 = (function (){var G__47221 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__47221) : syntax_list.call(null,G__47221));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47218,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47211__$1)].join('')));
...
var d = value;
var G__47246 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__47249 = G__47246;
var seq__47250 = cljs.core.seq(vec__47249);
var first__47251 = cljs.core.first(seq__47250);
var seq__47250__$1 = cljs.core.next(seq__47250);
var unparser = first__47251;
var more = seq__47250__$1;
var s = "";
var d__$1 = d;
var G__47246__$1 = G__47246;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__47266 = G__47246__$1;
var seq__47267 = cljs.core.seq(vec__47266);
var first__47268 = cljs.core.first(seq__47267);
var seq__47267__$1 = cljs.core.next(seq__47267);
var unparser__$1 = first__47268;
var more__$1 = seq__47267__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__47272 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47272,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47272,(1),null);
var G__47430 = d__$3;
var G__47431 = more__$1;
var G__47432 = s__$3;
d__$1 = G__47430;
G__47246__$1 = G__47431;
s__$1 = G__47432;
continue;
}
break;
